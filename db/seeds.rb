...
vel = D4.kittens.create({user_id: 2, name: "Velvet", gender: true, image: "IMG_6856.JPG", dob: "2018-05-17"})
vic = D4.kittens.create({user_id: 2, name: "Vice", gender: true, image: "Vice.JPG", dob: "2018-05-17"})
